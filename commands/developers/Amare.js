...
module.exports = {
   ...
   description: "This Command Tells You A Secret",
...
*/
   ...
   run: async (client, message, args) => {
      ...
      const amareembed = new MessageEmbed()
	   .setColor('#FF69B4')
      .setTitle(`Amare huh?`)
      .setDescription(`Ara-Ara Senpai~\nBasically Amare is the cutest,best,and coolest girl I've,the owner, ever met. And I'm now in love with them.`)
      .setTimestamp()
      message.reply({embeds: [amareembed]});
   },
};
